...
<body>
    ...
    <div class="jumbotron jumbotron-fluid page-header" style="margin-bottom: 30px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-3 mt-lg-5">Input Data Anak</h1>
    ...
    <div class="container">
        ...
        <h2>Input Data</h2>
        <br>
        <form method="POST" action="<?php echo "proses_bayi.php?aksi=tambah"; ?>">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="input" class="form-control" id="" name="berat_badan">
            </div>
            <div class="mb-3">
