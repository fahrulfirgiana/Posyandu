...
<body>
    ...
    <div class="jumbotron jumbotron-fluid page-header" style="margin-bottom: 30px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-3 mt-lg-5">Register Anak</h1>
    ...
    <div class="container">
        ...
        <h2>Input Data</h2>
        <br>
        <form method="POST" action="<?php echo "proses_bayi.php?aksi=update"; ?>">
            <div class="mb-3">
                <label class="form-label">ID Bayi</label>
                <input type="hidden" class="form-control" id="" name="kode" value="<?php echo $data_bayi['kode'] ?>">
                <input type="input" class="form-control" id="" name="kode1" value="<?php echo $data_bayi['kode'] ?>" disabled>
            </div>
            <div class="mb-3">
                <label class="form-label">Nama Anak</label>
                <input type="input" class="form-control" id="" name="nama_anak" value="<?php echo $data_bayi['nama_anak'] ?>">
            </div>
            <div class="form-group">
                <label>Jenis Kelamin</label>
                <select class="form-control" name="jeniskelamin" value="<?php echo $data_bayi['jeniskelamin'] ?>">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="" name="tanggal_lahir" value="<?php echo $data_bayi['tanggal_lahir'] ?>">
            </div>
            <div class="mb-3">
                <label class="form-label">Berat Badan</label>
                <input type="input" class="form-control" id="" name="berat_badan" value="<?php echo $data_bayi['berat_badan'] ?>">
            </div>
            <div class="mb-3">
                <label class="form-label">Nama Ayah</label>
                <input type="input" class="form-control" id="" name="nama_ayah" value="<?php echo $data_bayi['nama_ayah'] ?>">
            </div>
            <div class="mb-3">
                <label class="form-label">Nama Ibu</label>
                <input type="input" class="form-control" id="" name="nama_ibu" value="<?php echo $data_bayi['nama_ibu'] ?>">
            </div>
            <div class="mb-3">
