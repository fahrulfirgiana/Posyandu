...
$db = new database();
$kode = $_GET['id'];
$data_laporan = $db->tampil_laporan($kode);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="jumbotron jumbotron-fluid page-header" style="margin-bottom: 30px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-3 mt-lg-5">Register Hasil Kegiatan</h1>
    ...
    <div class="container">
        ...
        <h2>Input Data</h2>
        <br>
        <form method="POST" action="<?php echo "proses_laporan.php?aksi=update"; ?>">
            <div class="mb-3">
                <label class="form-label">ID</label>
                <input type="hidden" class="form-control" id="" name="id_laporan" value="<?php echo $data_laporan['id_laporan'] ?>">
                <input type="input" class="form-control" id="" name="id_laporan1" value="<?php echo $data_laporan['id_laporan'] ?>" disabled>
            </div>
            <div class="mb-3">
                <label class="form-label">Nama Bulan</label>
                <input type="input" class="form-control" id="" name="bulan" value="<?php echo $data_laporan['bulan'] ?>">
            </div>
            <div class="mb-3">
                <label class="form-label">Jumlah Ibu Hamil</label>
                <input type="input" class="form-control" id="" name="jml_ibuhamil" value="<?php echo $data_laporan['jml_ibuhamil'] ?>">
            </div>
            <div class="mb-3">
                <label class="form-label">Jumlah Diperiksa</label>
                <input type="input" class="form-control" id="" name="diperiksa" value="<?php echo $data_laporan['diperiksa'] ?>">
            </div>
            <div class="mb-3">
                <label class="form-label">Jumlah Ibu Menyusui</label>
                <input type="input" class="form-control" id="" name="ibu_menyusui" value="<?php echo $data_laporan['ibu_menyusui'] ?>">
            </div>
            <div class="mb-3">
                <label class="form-label">Jumlah Balita</label>
                <input type="input" class="form-control" id="" name="jml_balita" value="<?php echo $data_laporan['jml_balita'] ?>">
            </div>
            <div class="mb-3">
                <label class="form-label">Jumlah Bayi Yang Ditimbang</label>
                <input type="input" class="form-control" id="" name="jml_btimbang" value="<?php echo $data_laporan['jml_btimbang'] ?>">
            </div>
            <div class="mb-3">
