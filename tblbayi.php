...
<body>
    ...
    <div class="tol">
        <div class="lol">
            <div class="d-flex container-fluid">
                <div class="me-2">
                    <a class="btn btn-primary btn-sm" href="tambah_dbayi.php"><i class="fa-solid fa-circle-plus fa-sm"></i> Tambah Data</a>
                </div>
                <div>
                    <div>
                        <a class="btn btn-primary btn-sm" href="dataanakprint.php"><i class="fa-solid fa-print fa-sm"></i> Cetak semua data</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <nav class="navbar bg-light">
        <div>
            <form class="d-flex" method="POST" href="tbl_bayi.php">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><?= $row['nama_ayah']; ?></td>
                    <td><?= $row['nama_ibu']; ?></td>
                    <td><a href="<?php echo "ubahdatabayi.php?aksi=update&&id=$row[kode]" ?>" class="btn btn-sm"> <i class="fa-solid fa-pen-to-square" data-toggle="tooltip" title="Ubah"></i> Ubah</a>
                        <a href="<?php echo "proses_bayi.php?aksi=delete&&id=$row[kode]"; ?>" class="btn btn-sm" onclick="javascript: return confirm('Apakah yakin ingin menghapus data ini')"> <i class="fa-solid fa-circle-minus"></i> Hapus</a>
                    </td>
                </tr>
            <?php
            }
