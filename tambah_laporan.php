...
<body>
    ...
    <div class="jumbotron jumbotron-fluid page-header" style="margin-bottom: 30px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-3 mt-lg-5">Input Data Laporan</h1>
    ...
    <div class="container">
        ...
        <h2>Input Data</h2>
        <br>
        <form method="POST" action="<?php echo "proses_laporan.php?aksi=tambah"; ?>">
            <div class="mb-3">
                <label class="form-label">ID Laporan</label>
                <input type="input" class="form-control" id="" name="id_laporan" value="<?php echo date("m") . rand(1, 100) ?>" readonly>
            </div>
            <div class="mb-3">
                <label class="form-label">Nama Bulan</label>
                <input type="input" class="form-control" id="" name="bulan">
            </div>
            <div class="mb-3">
                <label class="form-label">Jumlah Ibu Hamil</label>
                <input type="input" class="form-control" id="" name="jml_ibuhamil">
            </div>
            <div class="mb-3">
                <label class="form-label">Jumlah Diperiksa</label>
                <input type="input" class="form-control" id="" name="diperiksa">
            </div>
            <div class="mb-3">
                <label class="form-label">Jumlah Ibu Menyusui</label>
                <input type="input" class="form-control" id="" name="ibu_menyusui">
            </div>
            <div class="mb-3">
                <label class="form-label">Jumlah Balita</label>
                <input type="input" class="form-control" id="" name="jml_balita">
            </div>
            <div class="mb-3">
                <label class="form-label">Jumlah Bayi Yng Ditimbang</label>
                <input type="input" class="form-control" id="" name="jml_btimbang">
            </div>
            <div class="mb-3">
